    ...
    >
      <div>
        ...
        <FormField
          ...
          disabled={false}
          className="border-none text-5xl font-bold bg-transparent px-0"
        />
      ...
      <div className="border-t pt-2">
        ...
        <div className="flex items-center justify-between gap-6">
          {blog && (
            <div>
              <Button onClick={handleSubmit(onDelete)} type="button">
          ...
          <div className="flex gap-4">
            ...
            <Button type="button" onClick={handleSubmit(onSaveDraft)}>
